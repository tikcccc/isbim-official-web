...
export function FooterDark() {
  ...
  return (
    <footer className="footer-dark w-full bg-black text-white border-t border-white/10 font-sans">
      <div className="container mx-auto px-6 py-14 lg:py-20">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-[13px] text-gray-500 space-y-3 md:space-y-0">
          ...
          <div className="flex space-x-7">
            ...
            <Link href={buildHref("/cookies")} className="hover:text-white transition-colors">
